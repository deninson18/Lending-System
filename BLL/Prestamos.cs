...
namespace BLL
{
    public class Prestamos : ClaseMaestra
    {
        ...
        public Prestamos(int prestamoId, int clienteId,string fechaInicial, string fechaVencimiento,float monto,int Semana, float cuotas, float interes, string tipoPrestamos)
        {
